...
# the tests are divided into two sets. The first part will help you debug the basic
# implementation

# the second part will test more comprehensibly
...
# then call them
tests.each_with_index {|v,i| if not v.call then  puts "Test #{i} failed: #{v}" end }  

# second part of testing

# add extra methods to the classes so we can test them
# this code is not OOP
